...
urlpatterns = [
    ...
    path(
        "contrats/<int:pk>/documents/",
        pdf_generator.telecharger_documents,
    ...
    path(
        "echeances/renouveler/<int:pk>/",
        views.renouveler_contrat_auto,
        name="renouveler_contrat_auto",
    ),
    # Clients
    ...
    path(
        "load-sous-categories/", views.load_sous_categories, name="load_sous_categories"
    ),
]
