...
class VehiculeAdmin(admin.ModelAdmin):
    ...
    @admin.display(description="Immatriculation", ordering="immatriculation")
    def display_immat(self, obj):

        if obj:
            return obj.immatriculation_formatted
        return "-"

    fieldsets = (
        ("Identification", {"fields": ("immatriculation", "marque", "modele")}),
        (
            "Caractéristiques",
            {
                "fields": (
        ...
        ("Valeurs", {"fields": ("valeur_neuve", "valeur_venale")}),
    )
...
class ContratAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ["client", "vehicule", "apporteur"]
    ...
    fieldsets = (
        ...
        ("Période", {"fields": ("duree", "date_effet", "date_echeance")}),
        (
            "Tarification",
            {"fields": ("prime_nette", "accessoires", "fga", "taxes", "prime_ttc")},
        ),
        ("Commission", {"fields": ("commission_apporteur", "net_a_reverser")}),
        (
            "Données API",
            {"fields": ("id_saisie_askia", "askia_response"), "classes": ("collapse",)},
        ),
        (
            "Métadonnées",
            {
