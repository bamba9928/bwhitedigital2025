...
urlpatterns = [
    ...
    path(
        "profile/quick-edit/", views.quick_edit_profile, name="quick_edit_profile"
    ),  # POST HTMX
    ...
    path(
        "apporteurs/<int:pk>/delete/", views.delete_apporteur, name="delete_apporteur"
    ),
    # Actions admin en lot et toggles
    path(
        "apporteurs/bulk-actions/",
        views.bulk_actions_apporteurs,
        name="bulk_actions_apporteurs",
    ),
    path(
        "apporteurs/<int:pk>/toggle-status/",
        views.toggle_apporteur_status,
        name="toggle_apporteur_status",
    ),
    path(
        "apporteurs/<int:pk>/change-grade/",
        views.change_apporteur_grade,
        name="change_apporteur_grade",
    ),
    # Export / Import
